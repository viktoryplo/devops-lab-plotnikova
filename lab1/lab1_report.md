...
![](alpine.png)
![](nginx.png)
5) Посмотрела запущенные контейнеры, все контейнеры
![](allcont.png)
Затем остановила контейнер, запустила установленный, остановила и удалила образ.  
7) Далее по инструкции  
   - создала том
   - запустила контейнер с томом
   - подключила и создала файл через: `echo "Hello from volume" > /data/test.txt`:
![](uprconteyn.png)  
8) Удалила контейнер и создала новый с тем же томом + проверила, что файл сохранился:
![](check.png)
